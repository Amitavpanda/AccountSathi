...
import { addSalesInfoSchema, addSupplierPurchaseSchema } from "../utils/validator"
...
export default function AddNewSalesComponent() {

    const form = useForm<z.infer<typeof addSalesInfoSchema>>({
        resolver: zodResolver(addSalesInfoSchema),
        defaultValues: {
            name: "",
            phoneNumber: "",
            address: "",
    ...
    async function onSubmit(values: z.infer<typeof addSalesInfoSchema>) {
    ...
    return (
        ...
        <div className="flex flex-col p-20 bg-gray-10 min-h-screen">
            <h2 className="bold-24 mb-5">Add New Hotel</h2>
            <div>
                <Form {...form}>
                        ...
                        <div className="flex flex-col gap-2 md:flex-row items-center justify-center">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input placeholder="Name of the Hotel" {...field} />
                                            </FormControl>
                                            <FormDescription>
                                                Name of the Hotel
                                            </FormDescription>
                            ...
                            <div className="flex-1">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>Propieder</FormLabel>
                                            <FormControl>
                                                <Input placeholder="Propieder" {...field} />
                                            </FormControl>
                                            <FormDescription>
                                                Propieder
                                            </FormDescription>
